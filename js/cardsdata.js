...
const PLANET_CONN_TEXT = {
  ...
  MercuryMoon: "Thought and feeling meet in this connection. Conversation can help private needs become easier to name, while memory and instinct shape what each person hears. There may be quick mental understanding alongside a strong sense of familiarity. The connection grows when both people listen beneath the words, speak directly about emotional needs, and offer care without expecting the other to guess or carry every feeling.",
