...
Divination and esoteric tools on a dark, starlit deck — a hand-built
...
no bundler, no runtime dependencies, no build.

## License

- **Code** — MIT (`LICENSE`).
- **Content and third-party notices** — the cardology readings and original
  Joker art are CC BY-NC 4.0; see [`NOTICES.md`](NOTICES.md).
